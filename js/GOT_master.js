(() => {
	...
	const sigils = document.querySelectorAll('.sigil-container'),
		  ...
		  stopLightBox = document.querySelector('.lightbox-close'),
	...
	sigils.forEach(sigil => sigil.addEventListener('click', houseData));

	video.addEventListener('ended', closeLightbox);
	stopLightBox.addEventListener('click', closeLightbox);
